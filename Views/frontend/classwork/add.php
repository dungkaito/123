<div class="container" style="padding-bottom:100px;">
    <form method="POST" action="?controller=classwork&action=add" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-10">
                <input type="file" accept="*/*" class="form-control-file" name="file">
            </div>
        </div>
    ...
    //     echo '<br>';
    //     if ($data['status'] == 1) {
    //         echo '<p style="text-align: center; font-size: 40px">Thêm bài tập thành công!</p>';
    //     } else {
    //         echo '<p style="text-align: center; font-size: 40px">Thêm bài tập thất bại!</p>';
    //     }
    // }
    ?>
</div>