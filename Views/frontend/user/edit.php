            ...
            <div class="col-md-8 mt-5">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control" name="username" value="<?php echo $data['user']['username'] ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-6">
                        <input type="text" class="form-control" name="password" value="<?php echo $data['user']['password'] ?>">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-2">
